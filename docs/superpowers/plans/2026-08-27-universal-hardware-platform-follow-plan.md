...
- 聚焦测试：U12 34 files / 106 tests 通过；U9 13/62、U10 20/46、U11 17/45 通过。
- 全量测试：329 files / 1622 tests；默认沙箱内 1619 项通过，3 项仅因禁止本机监听失败，精确回环复跑 2 files / 11 tests 通过。typecheck、三端 build、1043-file content scan 与 diff-check 通过。
