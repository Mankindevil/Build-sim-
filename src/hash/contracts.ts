...
export const HASH_CANONICALIZATION_POLICIES = deepFreeze({
  ...
  "fact-snapshot-content-v2": {
    setPaths: ["/factRefs", "/conflictRefs"],
    excludedPaths: ["/snapshotId", "/contentHash"],
  },
  "fact-record-content-v1": {
    setPaths: ["/evidenceRefs", "/derivedFromFactIds", "/assumptions"],
    excludedPaths: ["/contentHash"],
  },
  "fact-conflict-content-v1": {
    setPaths: ["/factIds", "/resolutionFactIds", "/decisionIds"],
    excludedPaths: ["/contentHash"],
  },
  "fact-identity-content-v1": {},
  "fact-inference-content-v1": {
    setPaths: ["/inputFactRefs", "/outputFactIds", "/assumptions", "/invalidationConditions"],
    excludedPaths: ["/inferenceTraceId", "/contentHash"],
  },
  "fact-update-decision-content-v1": {
    setPaths: ["/planIds", "/oldFactIds", "/newFactIds", "/fieldDiffs", "/affectedDomains"],
    excludedPaths: ["/updateDecisionId", "/contentHash"],
  },
  "plan-evaluation-lock-content-v1": { excludedPaths: ["/contentHash"] },
  "evidence-claim-content-v1": {
    excludedPaths: ["/claimId", "/contentHash"],
  },
...
export const HASH_DOMAIN_REGISTRY = deepFreeze({
  ...
  "simulation.logical-layout@1.0.0": { domain: "simulation.logical-layout", schemaVersion: "1.0.0", canonicalizationPolicyId: "canonical-json-v1" },
  "simulation.physical-path@1.0.0": { domain: "simulation.physical-path", schemaVersion: "1.0.0", canonicalizationPolicyId: "canonical-json-v1" },
  "simulation.input@1.0.0": { domain: "simulation.input", schemaVersion: "1.0.0", canonicalizationPolicyId: "canonical-json-v1" },
  "price.policy@1.0.0": { domain: "price.policy", schemaVersion: "1.0.0", canonicalizationPolicyId: "canonical-json-v1" },
  "price.history-point-id@1.0.0": { domain: "price.history-point-id", schemaVersion: "1.0.0", canonicalizationPolicyId: "canonical-json-v1" },
  "price.target-revision@1.0.0": { domain: "price.target-revision", schemaVersion: "1.0.0", canonicalizationPolicyId: "canonical-json-v1" },
  "price.target-event-id@1.0.0": { domain: "price.target-event-id", schemaVersion: "1.0.0", canonicalizationPolicyId: "canonical-json-v1" },
  "solver.candidate-promotion-id@1.0.0": { domain: "solver.candidate-promotion-id", schemaVersion: "1.0.0", canonicalizationPolicyId: "canonical-json-v1" },
  "recommendation.record-id@1.0.0": { domain: "recommendation.record-id", schemaVersion: "1.0.0", canonicalizationPolicyId: "canonical-json-v1" },
  "recommendation.what-if-id@1.0.0": { domain: "recommendation.what-if-id", schemaVersion: "1.0.0", canonicalizationPolicyId: "canonical-json-v1" },
  ...
  "fact-snapshot@fact-snapshot-v2": { domain: "fact-snapshot", schemaVersion: "fact-snapshot-v2", canonicalizationPolicyId: "fact-snapshot-content-v2" },
  "fact-record@fact-record-v1": { domain: "fact-record", schemaVersion: "fact-record-v1", canonicalizationPolicyId: "fact-record-content-v1" },
  "fact-conflict@fact-conflict-v1": { domain: "fact-conflict", schemaVersion: "fact-conflict-v1", canonicalizationPolicyId: "fact-conflict-content-v1" },
  "fact-identity@fact-identity-v1": { domain: "fact-identity", schemaVersion: "fact-identity-v1", canonicalizationPolicyId: "fact-identity-content-v1" },
  "fact-inference@fact-inference-v1": { domain: "fact-inference", schemaVersion: "fact-inference-v1", canonicalizationPolicyId: "fact-inference-content-v1" },
  "fact-update-decision@fact-update-decision-v1": { domain: "fact-update-decision", schemaVersion: "fact-update-decision-v1", canonicalizationPolicyId: "fact-update-decision-content-v1" },
  "plan-evaluation-lock@plan-evaluation-lock-v1": { domain: "plan-evaluation-lock", schemaVersion: "plan-evaluation-lock-v1", canonicalizationPolicyId: "plan-evaluation-lock-content-v1" },
  "evidence-claim@evidence-claim-v1": { domain: "evidence-claim", schemaVersion: "evidence-claim-v1", canonicalizationPolicyId: "evidence-claim-content-v1" },
