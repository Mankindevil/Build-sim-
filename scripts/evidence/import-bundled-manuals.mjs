...
export const BUNDLED_MANUALS = Object.freeze([
  Object.freeze({
    ...
    identity: Object.freeze({ brand: "JONSBO", basis: "official-document-explicit", model: "N6", category: "case", skuId: "case.jonsbo-n6" }),
  }),
  Object.freeze({
    ...
    officialBrand: "ASUS",
    identity: Object.freeze({ brand: "ASUS", basis: "official-document-explicit", model: "Pro WS W680M-ACE SE", category: "motherboard", skuId: "board.asus-w680m-ace-se" }),
  }),
]);
