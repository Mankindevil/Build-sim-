...
export async function loadRuntimeFlags(envOverride) {
  ...
  return Object.freeze({
    ...
    agentInferenceEnabled: boolEnv(env, "BUILD_SIM_AGENT_INFERENCE_ENABLED", false),
    ...
    spatialRoutingEnabled: boolEnv(env, "BUILD_SIM_SPATIAL_ROUTING_ENABLED", false),
    progressiveEvaluationEnabled: boolEnv(env, "BUILD_SIM_PROGRESSIVE_EVALUATION_ENABLED", false),
    thermalV3Enabled: boolEnv(env, "BUILD_SIM_THERMAL_V3_ENABLED", false),
    acousticV3Enabled: boolEnv(env, "BUILD_SIM_ACOUSTIC_V3_ENABLED", false),
    systemProfilesEnabled: boolEnv(env, "BUILD_SIM_SYSTEM_PROFILES_ENABLED", false),
    ...
    recommendationsEnabled: boolEnv(env, "BUILD_SIM_RECOMMENDATIONS_ENABLED", false),
    priceNetworkEnabled: boolEnv(env, "BUILD_SIM_PRICE_NETWORK_ENABLED", false),
